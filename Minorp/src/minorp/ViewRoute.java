...
String typer;
    ...
    public void viewroute1(String a)
    {
        typer=a;
    }
    ...
    private void initComponents() {
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 155, 515, 91));
        ...
        jPanel1.add(lgot, new org.netbeans.lib.awtextra.AbsoluteConstraints(465, 0, -1, -1));
...
class view
{
    ...
    void vw()
    {
        ...
        try
        {
            ...
            String[] colname={"Route Id","Source","Destination","Distance","Fare"};
            ...
            int i=0;
                while(rs.next())
                {
                    ...
                    ob[i][3]=Integer.parseInt(rs.getString(4));
                    ob[i][4]=Integer.parseInt(rs.getString(5));
                    i++;
                }
    ...
    private void bckActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bckActionPerformed
        if (typer.equals("employee"))
        {
            Employee e=new Employee();
            e.setVisible(true);
            this.setVisible(false);
        }
        else if(typer.equals("manager"))
        {
